...
(function () {
    ...
    $("#basic-non-sticky-notification-toggle").on(
        "click", function () {
            Toastify(
                {
    ...
    $("#basic-sticky-notification-toggle").on(
        "click", function () {
            Toastify(
                {
                    node: $("#basic-non-sticky-notification-content")
    ...
    $("#success-notification-toggle").on(
        "click", function () {
            Toastify(
                {
    ...
    $("#notification-with-actions-toggle").on(
        "click", function () {
            Toastify(
                {
    ...
    $("#notification-with-avatar-toggle").on(
        "click", function () {
            // Init toastify
    ...
    $("#notification-with-split-buttons-toggle").on(
        "click", function () {
            // Init toastify
    ...
    $("#notification-with-buttons-below-toggle").on(
        "click", function () {
            // Init toastify
            Toastify(
                {
